...
const dataNovinky = [
  {
    img: "./star-wars-fate-of-the-old-republic-logo-nahled.jpg",
  ...
  {
    img: "./control-resonant-nahled.jpg",
  ...
  {
    img: "./nejlepsi-telefony-2025-2.jpg",
  ...
  {
    img: "./tomb-raider-legacy-of-atlantis-nahled.jpg",
  ...
  {
    img: "./divinity-ann-trailer-portal-nahled.jpg",
  ...
  {
    img: "./ubrousky-latkove-jak-slozit.jpg",
  ...
  {
    img: "./cyberpunk-2077-5-vyroci-novinka-nahled.jpg",
  ...
  {
    img: "./telefony-zima-prevence-maly-zdroj-pexels-001.jpg",
  ...
  {
    img: "./kores-hlavni-banner-nahled.jpg",
      ...
      <div className="wrapper-novinky-content">
        <div className="wrapper-novinky-card">
          <div className="wrapper-novinky-img">
            <img
              src="./best-kids-tablet-thumb.jpg"
              alt="img-novinky"
        ...
        <div className="wrapper-novinky-card">
          <div className="wrapper-novinky-img">
            <img
              src="./resident-evil-requiem-grace-alyssa-nahled.jpg"
              alt="img-novinky"
              className="img-novinky"
            />
          </div>
